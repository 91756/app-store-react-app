...
class AppStore extends Component {
  ...
  getFilteredAppList = searchedApp => {
    const {activeTabId} = this.state
    const filteredAppLists = searchedApp.filter(
      eachApp => eachApp.category === activeTabId,
    )
    return filteredAppLists
  }
  ...
  render() {
    ...
    const filteredAppLists = this.getFilteredAppList(searchResults)
